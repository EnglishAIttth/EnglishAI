        ...
        <div class="detail-body">
            <div class="detail-group">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                    <div class="word-display">${item.emoji} ${item.word} <span style="font-size: 16px; color: var(--secondary); font-weight: normal; margin-left: 6px;">${item.wordPhonetic}</span></div>
        ...
        examplesHtml += `
            <div class="ipa-example-item">
                <div class="ipa-example-words">
                    <span class="ipa-word">${ex.word} <span style="font-size: 13.5px; color: var(--secondary); font-weight: normal; margin-left: 6px;">${ex.ipa}</span></span>
