...
const ALPHABET_DATA = [
    { letter: 'A', phonetic: '/eɪ/', word: 'Apple', translation: 'Quả táo', emoji: '🍎', example: 'An apple a day keeps the doctor away.', exampleTranslation: 'Mỗi ngày một quả táo giúp bạn tránh xa bác sĩ.' },
    { letter: 'B', phonetic: '/biː/', word: 'Banana', translation: 'Quả chuối', emoji: '🍌', example: 'Monkeys love eating bananas.', exampleTranslation: 'Những chú khỉ rất thích ăn chuối.' },
    { letter: 'C', phonetic: '/siː/', word: 'Cat', translation: 'Con mèo', emoji: '🐱', example: 'The cat is sleeping on the sofa.', exampleTranslation: 'Con mèo đang ngủ trên ghế sofa.' },
    { letter: 'D', phonetic: '/diː/', word: 'Dog', translation: 'Con chó', emoji: '🐶', example: 'Dogs are loyal friends.', exampleTranslation: 'Chó là những người bạn trung thành.' },
    { letter: 'E', phonetic: '/iː/', word: 'Elephant', translation: 'Con voi', emoji: '🐘', example: 'The elephant is very big.', exampleTranslation: 'Con voi rất là to lớn.' },
    { letter: 'F', phonetic: '/ef/', word: 'Fish', translation: 'Con cá', emoji: '🐟', example: 'Fish swim in the water.', exampleTranslation: 'Cá bơi dưới nước.' },
    { letter: 'G', phonetic: '/dʒiː/', word: 'Grapes', translation: 'Quả nho', emoji: '🍇', example: 'I like sweet purple grapes.', exampleTranslation: 'Tôi thích những quả nho tím ngọt ngào.' },
    { letter: 'H', phonetic: '/eɪtʃ/', word: 'House', translation: 'Ngôi nhà', emoji: '🏠', example: 'This is my warm little house.', exampleTranslation: 'Đây là ngôi nhà nhỏ ấm áp của tôi.' },
    { letter: 'I', phonetic: '/aɪ/', word: 'Ice-cream', translation: 'Kem', emoji: '🍦', example: 'I love eating ice-cream in summer.', exampleTranslation: 'Tôi thích ăn kem vào mùa hè.' },
    { letter: 'J', phonetic: '/dʒeɪ/', word: 'Jellyfish', translation: 'Con sứa', emoji: '🪼', example: 'Jellyfish glow in the dark ocean.', exampleTranslation: 'Sứa phát sáng trong lòng đại dương tăm tối.' },
    { letter: 'K', phonetic: '/keɪ/', word: 'Key', translation: 'Chìa khóa', emoji: '🔑', example: 'Don\'t forget your house key.', exampleTranslation: 'Đừng quên chìa khóa nhà của bạn.' },
    { letter: 'L', phonetic: '/el/', word: 'Lion', translation: 'Sư tử', emoji: '🦁', example: 'The lion is the king of the jungle.', exampleTranslation: 'Sư tử là chúa tể của rừng xanh.' },
    { letter: 'M', phonetic: '/em/', word: 'Monkey', translation: 'Con khỉ', emoji: '🐒', example: 'The monkey climbs trees fast.', exampleTranslation: 'Con khỉ trèo cây rất nhanh.' },
    { letter: 'N', phonetic: '/en/', word: 'Nest', translation: 'Tổ chim', emoji: '🪹', example: 'There are three eggs in the nest.', exampleTranslation: 'Có ba quả trứng ở trong tổ chim.' },
    { letter: 'O', phonetic: '/əʊ/', word: 'Orange', translation: 'Quả cam', emoji: '🍊', example: 'Orange juice is rich in Vitamin C.', exampleTranslation: 'Nước cam rất giàu Vitamin C.' },
    { letter: 'P', phonetic: '/piː/', word: 'Penguin', translation: 'Chim cánh cụt', emoji: '🐧', example: 'Penguins cannot fly but swim well.', exampleTranslation: 'Chim cánh cụt không thể bay nhưng bơi rất giỏi.' },
    { letter: 'Q', phonetic: '/kjuː/', word: 'Queen', translation: 'Nữ hoàng', emoji: '👑', example: 'The queen wears a golden crown.', exampleTranslation: 'Nữ hoàng đội một chiếc vương miện vàng.' },
    { letter: 'R', phonetic: '/ɑː(r)/', word: 'Rabbit', translation: 'Con thỏ', emoji: '🐰', example: 'The rabbit eats carrots.', exampleTranslation: 'Con thỏ ăn cà rốt.' },
    { letter: 'S', phonetic: '/es/', word: 'Sun', translation: 'Mặt trời', emoji: '☀️', example: 'The sun rises in the East.', exampleTranslation: 'Mặt trời mọc ở hướng Đông.' },
    { letter: 'T', phonetic: '/tiː/', word: 'Tiger', translation: 'Con hổ', emoji: '🐯', example: 'Tigers have black stripes.', exampleTranslation: 'Hổ có những vằn màu đen.' },
    { letter: 'U', phonetic: '/juː/', word: 'Umbrella', translation: 'Cây dù / ô', emoji: '☂️', example: 'Take an umbrella, it is raining.', exampleTranslation: 'Hãy mang theo ô, trời đang mưa đó.' },
    { letter: 'V', phonetic: '/viː/', word: 'Violin', translation: 'Đàn vĩ cầm', emoji: '🎻', example: 'She plays the violin beautifully.', exampleTranslation: 'Cô ấy chơi đàn vĩ cầm rất hay.' },
    { letter: 'W', phonetic: '/ˈdʌbljuː/', word: 'Watermelon', translation: 'Dưa hấu', emoji: '🍉', example: 'Watermelon is sweet and juicy.', exampleTranslation: 'Dưa hấu rất ngọt và nhiều nước.' },
    { letter: 'X', phonetic: '/eks/', word: 'Xylophone', translation: 'Đàn mộc cầm', emoji: '🪘', example: 'Children like playing the xylophone.', exampleTranslation: 'Trẻ em thích chơi đàn mộc cầm.' },
    { letter: 'Y', phonetic: '/waɪ/', word: 'Yacht', translation: 'Du thuyền', emoji: '⛵', example: 'They sail on a luxury yacht.', exampleTranslation: 'Họ đi du thuyền trên một chiếc du thuyền sang trọng.' },
    { letter: 'Z', phonetic: '/zed/', word: 'Zebra', translation: 'Ngựa vằn', emoji: '🦓', example: 'Zebras live in the savanna.', exampleTranslation: 'Ngựa vằn sống ở thảo nguyên.' }
];

const IPA_DATA = {
    vowels: [
        { sound: 'iː', type: 'Nguyên âm đơn dài', guide: 'Mở miệng tự nhiên, môi hơi kéo sang hai bên như đang mỉm cười. Phát âm âm /i/ kéo dài hơi.', examples: [{ word: 'see', trans: 'nhìn' }, { word: 'meet', trans: 'gặp gỡ' }, { word: 'key', trans: 'chìa khóa' }] },
        { sound: 'ɪ', type: 'Nguyên âm đơn ngắn', guide: 'Mở miệng nhỏ hơn âm /iː/, môi thư giãn. Phát âm âm /i/ thật ngắn, dứt khoát.', examples: [{ word: 'sit', trans: 'ngồi' }, { word: 'him', trans: 'anh ấy' }, { word: 'big', trans: 'to lớn' }] },
        { sound: 'uː', type: 'Nguyên âm đơn dài', guide: 'Môi tròn và chu ra phía trước. Phát âm âm /u/ kéo dài hơi từ sâu trong cổ họng.', examples: [{ word: 'blue', trans: 'màu xanh' }, { word: 'food', trans: 'thức ăn' }, { word: 'shoe', trans: 'chiếc giày' }] },
        { sound: 'ʊ', type: 'Nguyên âm đơn ngắn', guide: 'Môi hơi tròn nhưng không chu ra. Phát âm âm /u/ thật ngắn và dứt khoát.', examples: [{ word: 'book', trans: 'cuốn sách' }, { word: 'good', trans: 'tốt' }, { word: 'foot', trans: 'bàn chân' }] },
        { sound: 'e', type: 'Nguyên âm đơn ngắn', guide: 'Mở miệng rộng hơn âm /ɪ/ một chút. Phát âm âm /e/ ngắn, gọn gàng.', examples: [{ word: 'pen', trans: 'bút viết' }, { word: 'bed', trans: 'chiếc giường' }, { word: 'help', trans: 'giúp đỡ' }] },
        { sound: 'ə', type: 'Nguyên âm lười', guide: 'Mở miệng nhỏ, môi và lưỡi thả lỏng hoàn toàn. Phát âm âm nhẹ như "ơ" Việt Nam.', examples: [{ word: 'about', trans: 'về' }, { word: 'teacher', trans: 'giáo viên' }, { word: 'banana', trans: 'quả chuối' }] },
        { sound: 'ɜː', type: 'Nguyên âm đơn dài', guide: 'Mở miệng tương tự âm /ə/ nhưng lưỡi hơi cong lên. Phát âm âm "ơ" kéo dài.', examples: [{ word: 'girl', trans: 'cô gái' }, { word: 'bird', trans: 'con chim' }, { word: 'learn', trans: 'học tập' }] },
        { sound: 'ɔː', type: 'Nguyên âm đơn dài', guide: 'Tròn môi, lưỡi hơi kéo về phía sau. Phát âm âm "o" tròn và kéo dài.', examples: [{ word: 'door', trans: 'cửa ra vào' }, { word: 'water', trans: 'nước' }, { word: 'ball', trans: 'quả bóng' }] },
        { sound: 'æ', type: 'Nguyên âm bẹt', guide: 'Mở miệng rộng hết cỡ về cả chiều dọc và ngang. Phát âm lai giữa âm /a/ và /e/.', examples: [{ word: 'cat', trans: 'con mèo' }, { word: 'sad', trans: 'buồn bã' }, { word: 'apple', trans: 'quả táo' }] },
        { sound: 'ʌ', type: 'Nguyên âm đơn ngắn', guide: 'Mở miệng nhỏ hơn âm /æ/, hơi lai giữa âm /a/ và /ă/. Phát âm dứt khoát.', examples: [{ word: 'cup', trans: 'cái cốc' }, { word: 'bus', trans: 'xe buýt' }, { word: 'sun', trans: 'mặt trời' }] },
        { sound: 'ɑː', type: 'Nguyên âm đơn dài', guide: 'Mở miệng rộng tự nhiên theo chiều dọc. Phát âm âm /a/ kéo dài hơi từ cổ họng.', examples: [{ word: 'car', trans: 'xe hơi' }, { word: 'father', trans: 'bố' }, { word: 'star', trans: 'ngôi sao' }] },
        { sound: 'ɒ', type: 'Nguyên âm đơn ngắn', guide: 'Mở miệng tròn, lưỡi hạ thấp. Phát âm âm /o/ thật ngắn và dứt khoát.', examples: [{ word: 'hot', trans: 'nóng' }, { word: 'box', trans: 'chiếc hộp' }, { word: 'dog', trans: 'con chó' }] }
    ],
    diphthongs: [
        { sound: 'ɪə', type: 'Nguyên âm đôi', guide: 'Phát âm âm /ɪ/ rồi chuyển dần sang âm /ə/. Đọc nối mượt mà.', examples: [{ word: 'here', trans: 'ở đây' }, { word: 'near', trans: 'gần' }, { word: 'beer', trans: 'bia' }] },
        { sound: 'eə', type: 'Nguyên âm đôi', guide: 'Phát âm âm /e/ rồi chuyển dần sang âm /ə/. Đọc nối mượt mà.', examples: [{ word: 'hair', trans: 'tóc' }, { word: 'there', trans: 'đằng kia' }, { word: 'wear', trans: 'mặc' }] },
        { sound: 'ʊə', type: 'Nguyên âm đôi', guide: 'Phát âm âm /ʊ/ rồi chuyển dần sang âm /ə/. Đọc nối mượt mà.', examples: [{ word: 'tour', trans: 'chuyến du lịch' }, { word: 'poor', trans: 'nghèo' }, { word: 'cure', trans: 'chữa trị' }] },
        { sound: 'eɪ', type: 'Nguyên âm đôi', guide: 'Phát âm âm /e/ rồi chuyển dần sang âm /ɪ/. Giống âm "ây" nhưng kéo dài hơi.', examples: [{ word: 'day', trans: 'ngày' }, { word: 'say', trans: 'nói' }, { word: 'train', trans: 'tàu hỏa' }] },
        { sound: 'ɔɪ', type: 'Nguyên âm đôi', guide: 'Phát âm âm /ɔː/ rồi chuyển dần sang âm /ɪ/. Giống âm "oi" kéo dài.', examples: [{ word: 'boy', trans: 'cậu bé' }, { word: 'toy', trans: 'đồ chơi' }, { word: 'coin', trans: 'tiền xu' }] },
        { sound: 'aɪ', type: 'Nguyên âm đôi', guide: 'Phát âm âm /ɑː/ rồi chuyển dần sang âm /ɪ/. Giống âm "ai" kéo dài.', examples: [{ word: 'my', trans: 'của tôi' }, { word: 'fly', trans: 'bay' }, { word: 'night', trans: 'ban đêm' }] },
        { sound: 'əʊ', type: 'Nguyên âm đôi', guide: 'Phát âm âm /ə/ rồi chuyển dần sang âm /ʊ/. Giống âm "âu" kéo dài.', examples: [{ word: 'go', trans: 'đi' }, { word: 'no', trans: 'không' }, { word: 'home', trans: 'nhà' }] },
        { sound: 'aʊ', type: 'Nguyên âm đôi', guide: 'Phát âm âm /ɑː/ rồi chuyển dần sang âm /ʊ/. Giống âm "ao" kéo dài.', examples: [{ word: 'now', trans: 'bây giờ' }, { word: 'cow', trans: 'con bò' }, { word: 'house', trans: 'ngôi nhà' }] }
    ],
    consonants: [
        { sound: 'p', type: 'Phụ âm vô thanh', guide: 'Mím chặt hai môi, nén hơi lại rồi bật mạnh hơi ra ngoài (không rung dây thanh).', examples: [{ word: 'pen', trans: 'bút' }, { word: 'map', trans: 'bản đồ' }] },
        { sound: 'b', type: 'Phụ âm hữu thanh', guide: 'Khẩu hình tương tự âm /p/ nhưng rung dây thanh quản khi bật âm.', examples: [{ word: 'bed', trans: 'giường' }, { word: 'cab', trans: 'taxi' }] },
        { sound: 't', type: 'Phụ âm vô thanh', guide: 'Đặt đầu lưỡi ở chân răng trên, bật hơi mạnh ra ngoài (không rung dây thanh).', examples: [{ word: 'tea', trans: 'trà' }, { word: 'cat', trans: 'con mèo' }] },
        { sound: 'd', type: 'Phụ âm hữu thanh', guide: 'Khẩu hình tương tự âm /t/ nhưng rung dây thanh quản khi bật âm.', examples: [{ word: 'dog', trans: 'con chó' }, { word: 'red', trans: 'màu đỏ' }] },
        { sound: 'f', type: 'Phụ âm vô thanh', guide: 'Đặt răng hàm trên chạm nhẹ vào môi dưới, đẩy hơi thoát ra qua kẽ răng.', examples: [{ word: 'fish', trans: 'con cá' }, { word: 'safe', trans: 'an toàn' }] },
        { sound: 'v', type: 'Phụ âm hữu thanh', guide: 'Khẩu hình tương tự âm /f/ nhưng rung dây thanh quản khi đẩy hơi.', examples: [{ word: 'van', trans: 'xe tải' }, { word: 'love', trans: 'yêu' }] },
        { sound: 'k', type: 'Phụ âm vô thanh', guide: 'Nâng phần sau của lưỡi chạm ngạc mềm, bật hơi mạnh ra từ cổ họng.', examples: [{ word: 'key', trans: 'chìa khóa' }, { word: 'book', trans: 'sách' }] },
        { sound: 'ɡ', type: 'Phụ âm hữu thanh', guide: 'Khẩu hình tương tự âm /k/ nhưng rung dây thanh quản khi bật âm.', examples: [{ word: 'go', trans: 'đi' }, { word: 'bag', trans: 'cái túi' }] },
        { sound: 's', type: 'Phụ âm vô thanh', guide: 'Đặt hai hàm răng gần chạm nhau, đẩy hơi nhẹ qua khe giữa hai răng.', examples: [{ word: 'sun', trans: 'mặt trời' }, { word: 'bus', trans: 'xe buýt' }] },
        { sound: 'z', type: 'Phụ âm hữu thanh', guide: 'Khẩu hình tương tự âm /s/ nhưng rung dây thanh quản khi đẩy hơi.', examples: [{ word: 'zoo', trans: 'sở thú' }, { word: 'buzz', trans: 'tiếng vo ve' }] },
        { sound: 'ʃ', type: 'Phụ âm vô thanh', guide: 'Chu môi tròn ra phía trước, đẩy hơi mạnh qua kẽ răng (âm "xì" nặng).', examples: [{ word: 'she', trans: 'cô ấy' }, { word: 'fish', trans: 'con cá' }] },
        { sound: 'ʒ', type: 'Phụ âm hữu thanh', guide: 'Khẩu hình tương tự âm /ʃ/ nhưng rung dây thanh quản khi đẩy hơi.', examples: [{ word: 'vision', trans: 'tầm nhìn' }, { word: 'casual', trans: 'bình thường' }] },
        { sound: 'tʃ', type: 'Phụ âm vô thanh', guide: 'Phát âm âm /t/ rồi chuyển nhanh sang âm /ʃ/, bật hơi mạnh ra ngoài.', examples: [{ word: 'chair', trans: 'cái ghế' }, { word: 'much', trans: 'nhiều' }] },
        { sound: 'dʒ', type: 'Phụ âm hữu thanh', guide: 'Khẩu hình tương tự âm /tʃ/ nhưng rung dây thanh quản khi bật âm.', examples: [{ word: 'job', trans: 'công việc' }, { word: 'page', trans: 'trang giấy' }] },
        { sound: 'θ', type: 'Phụ âm vô thanh', guide: 'Đặt đầu lưỡi giữa hai hàm răng, đẩy hơi nhẹ ra ngoài qua kẽ răng.', examples: [{ word: 'thin', trans: 'mỏng, gầy' }, { word: 'bath', trans: 'bồn tắm' }] },
        { sound: 'ð', type: 'Phụ âm hữu thanh', guide: 'Khẩu hình tương tự âm /θ/ nhưng rung dây thanh quản khi đẩy hơi.', examples: [{ word: 'this', trans: 'cái này' }, { word: 'mother', trans: 'mẹ' }] },
        { sound: 'm', type: 'Phụ âm mũi', guide: 'Mím môi, đẩy hơi thoát ra hoàn toàn bằng đường mũi (rung thanh quản).', examples: [{ word: 'my', trans: 'của tôi' }, { word: 'him', trans: 'anh ấy' }] },
        { sound: 'n', type: 'Phụ âm mũi', guide: 'Đặt đầu lưỡi chạm nướu răng trên, đẩy hơi thoát ra bằng đường mũi.', examples: [{ word: 'no', trans: 'không' }, { word: 'sun', trans: 'mặt trời' }] },
        { sound: 'ŋ', type: 'Phụ âm mũi', guide: 'Chặn hơi ở phần cuống lưỡi và ngạc mềm, đẩy hơi thoát ra bằng đường mũi.', examples: [{ word: 'sing', trans: 'hát' }, { word: 'ring', trans: 'nhẫn' }] },
        { sound: 'h', type: 'Phụ âm vô thanh', guide: 'Mở miệng tự nhiên, thở hơi nhẹ ra từ cổ họng giống như đang thở dài.', examples: [{ word: 'home', trans: 'nhà' }, { word: 'hat', trans: 'cái mũ' }] },
        { sound: 'l', type: 'Phụ âm bên', guide: 'Đặt đầu lưỡi chạm chân răng trên, luồng hơi đi ra qua hai bên cạnh lưỡi.', examples: [{ word: 'love', trans: 'yêu thương' }, { word: 'ball', trans: 'quả bóng' }] },
        { sound: 'r', type: 'Phụ âm tiếp cận', guide: 'Cong đầu lưỡi về phía sau nhưng không chạm ngạc, đẩy hơi nhẹ ra ngoài.', examples: [{ word: 'red', trans: 'màu đỏ' }, { word: 'run', trans: 'chạy' }] },
        { sound: 'w', type: 'Bán nguyên âm', guide: 'Tròn môi giống như phát âm âm /uː/ rồi mở nhanh môi để phát âm.', examples: [{ word: 'wet', trans: 'ẩm ướt' }, { word: 'win', trans: 'chiến thắng' }] },
        { sound: 'j', type: 'Bán nguyên âm', guide: 'Khẩu hình tương tự âm /iː/ rồi mở nhanh miệng để phát âm giống âm "d" nhẹ.', examples: [{ word: 'yes', trans: 'vâng, có' }, { word: 'you', trans: 'bạn' }] }
    ]
};
...
const SCENARIO_DATA = [
    ...
    },
    {
        ...
        dialogue: [
            ...
            { speaker: 'Local', text: 'It is very close, only about a five-minute walk. You don\'t need a taxi.', ipa: '/ɪt ɪz ˈveri kləʊs, ˈəʊnli əˈbaʊt ə faɪv ˈmɪnɪt wɔːk. juː dəʊnt niːd ə ˈtæksi./', trans: 'Nó rất gần, chỉ khoảng 5 phút đi bộ thôi. Bạn không cần đi taxi đâu.' },
    ...
    },
    {
        ...
        dialogue: [
            ...
            { speaker: 'Customer', text: 'It fits perfectly. Do you have it in white as well?', ipa: '/ɪt fɪts ˈpɜːfɪktli. duː juː hæv ɪt ɪn waɪt æz wel?/', trans: 'Nó vừa vặn hoàn hảo luôn. Bạn có mẫu này màu trắng luôn không?' },
    ...
    },
    {
        ...
        dialogue: [
            ...
            { speaker: 'Tourist', text: 'Good idea. I have my phone, so I can look up the embassy phone number.', ipa: '/ɡʊd aɪˈdɪə. aɪ hæv maɪ fəʊn, səʊ aɪ kæn lʊk ʌp ðə ˈembəsi fəʊn ˈnʌmbə(r)./', trans: 'Ý kiến hay đó. Tôi vẫn giữ điện thoại nên tôi có thể tra cứu số điện thoại đại sứ quán.' },
...
const SENTENCE_STRUCTURES_DATA = [
    ...
    },
    {
        ...
        examples: [
            { eng: 'The man who is standing there is my teacher.', vi: 'Người đàn ông đang đứng đằng kia là giáo viên của tôi ("Who" bổ nghĩa cho "The man" làm chủ ngữ).' },
